...
mediante una página web creada con las tecnologías HTML, CSS y JavaScript, y aplicando los conocimientos vistos en los módulos del curso Course Frontend.
